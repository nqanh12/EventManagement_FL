...
import 'package:eventmanagement/Component/form_add_event.dart';
import 'package:eventmanagement/Component/form_edit_event.dart';
...
void editEvent(Event event) {
  ...
  List<Event> _filterEvents() {
    ...
    return _events.where((event) {
      ...
      bool matchesDepartment = _selectedDepartment == 'Tất cả' || event.departmentId == _selectedDepartment;
      ...
      return matchesName && matchesYear && matchesStatus && matchesDepartment && matchesSemester  && courseMatches;
    }).toList();
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                          ...
                          items: <String>['Tất cả', ..._departments.map((dept) => dept.departmentId)]
                              .map((String value) {
                            return DropdownMenuItem<String>(
                              value: value,
                              child: CustomText(
                                text: value == 'Tất cả' ? 'Tất cả' : _departments.firstWhere((dept) => dept.departmentId == value).departmentName,
                                fontSize: 18,
                                color: Colors.black,
                              ),
                            );
