...
class FormAddAccountManagerEntireDialog extends StatefulWidget {
  final VoidCallback callback;
  const FormAddAccountManagerEntireDialog({super.key, required this.callback});

  @override
  FormAddAccountManagerEntireDialogState createState() => FormAddAccountManagerEntireDialogState();
}

class FormAddAccountManagerEntireDialogState extends State<FormAddAccountManagerEntireDialog> {
  ...
  final List<String> _roles = ['MANAGER_ENTIRE'];
    ...
    return AlertDialog(
      ...
      title: Row(
        children: [
          ...
          CustomText(
            text: 'Thêm tài khoản quét mã QR cho sự kiện toàn trường',
            fontSize: 18,
