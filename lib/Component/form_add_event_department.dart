...
class FormAddEventDepartmentDialog extends StatefulWidget {
  final VoidCallback callback;
  const FormAddEventDepartmentDialog({super.key, required this.callback});

  @override
  FormAddEventDepartmentDialogState createState() => FormAddEventDepartmentDialogState();
}

class FormAddEventDepartmentDialogState extends State<FormAddEventDepartmentDialog> {
